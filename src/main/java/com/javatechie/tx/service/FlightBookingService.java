...
//    @Transactional(rollbackFor = {InsufficientAmountException.class})
    ...
    public CompletableFuture<List<PassengerInfo>> findAllPassengerInfo() {
    ...
    public CompletableFuture<List<PaymentInfo>> findPaymentInfo() {

        return CompletableFuture.supplyAsync(() ->
                paymentInfoRepository.findAll());
